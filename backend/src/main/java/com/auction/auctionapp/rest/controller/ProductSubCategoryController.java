...
public class ProductSubCategoryController {
    ...
    @ApiOperation(value = "Get all the Subcategories by Category", response = ProductSubCategoryResponse.class)
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Get all the Subcategories", response = ProductSubCategoryResponse.class)
    @ApiResponses(value = {
            @ApiResponse(code = 500, message = "Server error"),
            @ApiResponse(code = 200, message = "Successful retrieval",
                    response = ProductSubCategoryResponse.class, responseContainer = "List"),
    ...
    public ResponseEntity<List<ProductSubCategoryResponse>> getAllSubCategories() {
        return ResponseEntity.ok(new ArrayList<ProductSubCategoryResponse>(productService.getAllSubCategories()));
    }
}
