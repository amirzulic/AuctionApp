...
export const loadDefaultSortingByCategory = async (id) => {
    return await axios.get(process.env.REACT_APP_D_URL + "/products/default-sorting", {params: {productCategoryId: id}});
}

export const loadNewArrivalsByCategory = async (id) => {
    return await axios.get(process.env.REACT_APP_D_URL + "/products/new-category", {params: {productCategoryId: id}});
}

export const loadLastChanceByCategory = async (id) => {
    return await axios.get(process.env.REACT_APP_D_URL + "/products/last-category", {params: {productCategoryId: id}});
}

export const loadHighToLowByCategory = async (id) => {
    return await axios.get(process.env.REACT_APP_D_URL + "/products/high-low", {params: {productCategoryId: id}});
}

export const loadLowToHighByCategory = async (id) => {
    return await axios.get(process.env.REACT_APP_D_URL + "/products/low-high", {params: {productCategoryId: id}});
}
